...
A React + TypeScript project that demonstrates e-commerce user flows such as mega menu navigation, product browsing, cart and checkout experience and user dashboard.  
